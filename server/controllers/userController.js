...
export const signin = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ email: existingUser.email, id: existingUser._id, isOwner: existingUser.isOwner }, process.env.JWT_SECRET, { expiresIn: '1h' });
...
export const signup = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ email: result.email, id: result._id, isOwner: result.isOwner }, process.env.JWT_SECRET, { expiresIn: "1h" });
